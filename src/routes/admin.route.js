...
router.post('/register/',[
    ...
    check('adm_email', 'El correo debe de terminar en @unifranz.edu.bo' ).contains('@unifranz.edu.bo'),
    check('adm_email').custom( emailExists ),
    validarCampos
], validarJWT, registerAdministrator );


router.put('/updatepwd/:Id',validarJWT,updatePwd)

router.put('/update/:Id',validarJWT,updateAdministrator)

router.get('/campus/:Campus',validarJWT,getCampusById)

router.get('/areacampus/:Id',validarJWT,getAdministratorsByAreaCampus)
